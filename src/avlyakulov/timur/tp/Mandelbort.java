 ...
 * @author tvcutsem
 */
public class Mandelbort extends Canvas {
     ...
     */
    public Mandelbort(int height, boolean optParallel, boolean optDrawGrid) {
    ...
    public static void main(String args[]) {
        ...
        Frame f = new Frame();
        Mandelbort canvas = new Mandelbort(HEIGHT, optParallel, optDrawGrid);
